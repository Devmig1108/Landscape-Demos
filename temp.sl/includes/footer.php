...
<footer class="footer-sec">
    <div class="footer-content">
        <div class="footer-brand reveal-up">
            <img src="<?php echo $base_url; ?>images/logo.jpg" alt="SL General Contractors Logo" class="logo-img dynamic-logo"
        ...
        <div class="footer-column reveal-up" style="transition-delay: 0.2s;">
            ...
            <ul>
                <li><a href="tel:915555-0199" class="contact-gold hover-target">(915) 555-0199</a></li>
                <li><span
    ...
    <div class="footer-bottom reveal-up" style="transition-delay: 0.3s;">
        <p>&copy; <?php echo date("Y"); ?> SL General Contractors.</p>
        <div class="social-lux">
            <a href="https://www.facebook.com/profile.php?id=100081610521213/" target="_blank"
