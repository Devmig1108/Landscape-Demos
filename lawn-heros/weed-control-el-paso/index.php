...
$schemaJson = '{
  ...
  "description": "Professional selective and non-selective weed control services, featuring pre-emergent seed barriers and targeted elimination for rock beds and turf in the Chihuahuan desert."
}';
...
<header class="internal-hero" style="background: linear-gradient(135deg, rgba(39, 99, 42, 0.95) 0%, rgba(15, 23, 42, 0.8) 100%), url('../images/side-lawn.jpeg') center/cover;">
    <div class="container">
        ...
        <p class="reveal-up" style="transition-delay: 0.2s;">Eradicate existing weeds and establish permanent pre-emergent barriers. Stop pulling weeds and let our family protect your rock landscapes and turf.</p>
    </div>
</header>
...
<section class="page-section">
    <div class="container content-grid">
        ...
        <div class="text-block reveal-up">
            ...
            <p>Hand-pulling is a losing battle. Why? Because it only addresses the visible plant. It leaves thousands of dormant seeds waiting in the dirt beneath your rocks, completely untouched. At Lawn Heros, our Father & Sons company approaches weed control differently. We don't just treat the symptom; we engineer a chemical barrier to eradicate the source.</p>
            ...
            <p>For properties with extensive rock beds, turf edges, sidewalks, and expansion joints, we utilize a highly effective <strong>Non-Selective</strong> weed control strategy. This is a total-eradication approach.</p>
            ...
            <h2>Selective Weed Control (Turf & Lawns)</h2>
            <p>If you have weeds invading your Bermuda, Fescue, or hybrid grass, applying a non-selective formula will destroy your lawn. This is where our technical expertise in <strong>Selective Weed Control</strong> comes in.</p>

            <p>Elimination of existing weeds inside of grass is delicate work. It is done using a highly calibrated mixture that targets and kills broadleaf and grassy weeds <em>without</em> harming your surrounding turf. It is critical to properly identify the exact species of weed to select the correct mixture type.</p>
