...
$pageDescription = "El Paso's lawn science experts. We specialize in custom 4-1-2 NPK fertilization, selective weed control, and soil conditioning for Bermuda and southern lawns.";
...
?>
    ...
    <header class="internal-hero" style="background: linear-gradient(135deg, rgba(39, 99, 42, 0.95) 0%, rgba(15, 23, 42, 0.8) 100%), url('../images/side-lawn.jpeg') center/cover;">
        <div class="container">
            <span class="hero-badge reveal-up">Lawn Science & Agronomy</span>
            <h1 class="reveal-up" style="transition-delay: 0.1s;">Lawn Care & Fertilization</h1>
            <p class="reveal-up" style="transition-delay: 0.2s;">We don't do grass maintenance. Instead, we engineer healthy, vibrant, weed-free lawn using data-driven chemistry and premium soil conditioning.</p>
        </div>
    </header>
    ...
    <section class="page-section">
        <div class="container content-grid">
            ...
            <div class="text-block reveal-up">
                ...
                <h2>Selective Weed Eradication in Lawn</h2>
                <p>Weeds are the enemy of a pristine lawn. However, you cannot use standard weed killers on your grass without destroying the grass itself. We utilize <strong>Selective Weed Control</strong>—a highly calibrated chemical mixture that targets and kills broadleaf and grassy weeds while leaving your Bermuda grass completely unharmed.</p>
                ...
                <ul>
                    <li><strong>Nitrogen (N):</strong> Bermuda grass requires heavy Nitrogen. This powers the rapid growth of the grass blades and fuels the spreading of the lawn via both Rhizomes and Stolons (runners).</li>
                ...
                <p>You can pump all the fertilizer you want into your lawn, but if your soil is unbalanced, the plant cannot absorb the nutrients. When it comes to a healthy plant, flower, or grass in the desert, <strong>Soil is King</strong>.</p>
                ...
                <h3>Comprehensive Lawn Consulting</h3>
